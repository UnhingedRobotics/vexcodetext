...
void                vexAiVisionReset( uint32_t index );
void                vexAiVisionEnableSet( uint32_t index, uint8_t nEnables, uint8_t nMask );
uint8_t             vexAiVisionEnableGet( uint32_t index );
